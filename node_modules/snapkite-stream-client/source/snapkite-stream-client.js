...
function initializeStream(handleNewTweet, streamConfig) {
  ...
  console.log("stream initialized on snapkite-stream-client.js");
  ...
  window.setInterval(function () {
    ...
    if (tweet) {
      ...
      console.log("snapkite-stream-cliient.js tweet handler called - it means there is at least one tweet");
    }
