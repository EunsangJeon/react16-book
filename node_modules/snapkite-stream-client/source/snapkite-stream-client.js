...
function initializeStream(handleNewTweet, streamConfig) {
  console.log("Tweet stream has been started snapkite-stream-client.js");
  console.log("handleNewTweet: " + handleNewTweet);
  ...
  socket.on('tweet', function (tweet) {
    console.log('[Snapkite Stream Client] New tweet');
